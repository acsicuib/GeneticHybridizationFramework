...
if __name__ == "__main__":
    ...
    for seed2 in range(1,N_EXECUTIONS+1):
        ...
        for algorithm in based_hybrid:
            ...
            input_file = file_hybrids.format(algorithm=algorithm,seed2=seed2,POP_SIZE=POP_SIZE,HYBRID_N_GEN=HYBRID_N_GEN)
        ...
        do.to_csv(path_exp_hybrids+"table_merge_{seed2}.csv", index=False)
        print(f"File table_merge_{seed2}.csv saved")
